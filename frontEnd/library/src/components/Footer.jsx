...
export default function Footer() {
    ...
    const backGround = () => {
        if (currentUrl === "http://localhost:8000/") {
            ...
            return "fixed inset-x-0 bottom-0 bottom left-0 w-full p-4 shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800 dark:border-gray-600 ";
        }
